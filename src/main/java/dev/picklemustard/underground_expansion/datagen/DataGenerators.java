...
public class DataGenerators{
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        DatapackBuiltinEntriesProvider builtinProvider = new DatapackBuiltinEntriesProvider(packOutput, lookupProvider, ModDatapackProvider.BUILDER, Set.of(UndergroundExpansion.MODID));
        gen.addProvider(event.includeServer(), builtinProvider);
        lookupProvider = builtinProvider.getRegistryProvider();
        ...
        gen.addProvider(event.includeServer(), new ModBiomeTagProvider(packOutput, lookupProvider, existingFileHelper));
